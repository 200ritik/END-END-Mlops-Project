...
class DataForm:
    """
    Class used to receive and process vehicle form data.
    """
    ...
    async def get_vehicle_data(self):
        """
        Retrieve vehicle data submitted through the HTML form.
        """
...
async def index(request: Request):
    """
    Render the vehicle prediction form.
    """
...
async def predictRouteClient(request: Request):
    ...
    try:
        ...
        # ----------------------------------------------------
        # 7. Render HTML page with prediction
        # ----------------------------------------------------
